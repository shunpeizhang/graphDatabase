...
SOURCEFILES := graphDB.cpp src/Common/PublicFun.cpp src/Core/Edge.cpp src/Core/Graph.cpp src/Core/Node.cpp src/Core/NodeProperty.cpp src/GraphDataBase.cpp src/IO/IfIOStrategy.cpp src/IO/XMLStrategy.cpp src/Parser/CypherParser.cpp src/Parser/FilterRule.cpp src/Parser/MatchRule.cpp src/Parser/MidResult.cpp src/Parser/StartRule.cpp
EXTERNAL_LIBS := 
...
$(BINARYDIR)/PublicFun.o : src/Common/PublicFun.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/Edge.o : src/Core/Edge.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/Graph.o : src/Core/Graph.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/Node.o : src/Core/Node.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/NodeProperty.o : src/Core/NodeProperty.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/GraphDataBase.o : src/GraphDataBase.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/IfIOStrategy.o : src/IO/IfIOStrategy.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/XMLStrategy.o : src/IO/XMLStrategy.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/CypherParser.o : src/Parser/CypherParser.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/FilterRule.o : src/Parser/FilterRule.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/MatchRule.o : src/Parser/MatchRule.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/MidResult.o : src/Parser/MidResult.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/StartRule.o : src/Parser/StartRule.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
